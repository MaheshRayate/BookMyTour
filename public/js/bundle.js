...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe("pk_test_51RH0rQRqRVZb2gbZpS3kt8Clur7ktq65DT0QyiL6sUni2Z407WzFgCDCdaOudHDp18QSbf0o3hxn0XopaCGbUSbi00CfhCfOVR");
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    var coords = [lat, lng]; // Reverse to [lat, lng]

    // Create and add marker
    L.marker(coords).addTo(map).bindPopup("<strong>Day ".concat(loc.day, ":</strong> ").concat(loc.description)).openPopup();
    bounds.push(coords);
  });
...
if (mapBox) {
  var x = mapBox.dataset.locations;
...
},{"./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js","./mapbox.js":"mapbox.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
